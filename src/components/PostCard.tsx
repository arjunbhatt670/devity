...
const dataSvg = 'data:image/svg+xml;base64,CiAgPHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPgogICAgPHNjcmlwdD5hbGVydCgnWFNTJyk8L3NjcmlwdD4KICA8L3N2Zz4K';

export function PostCard({ username, body, htmlContent }: { username: string; body: string; htmlContent: string }) {
  return (
    <div className="max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-200">
      ...
      <Image
        ...
        height={100}
      />
      <h3 className="text-black font-bold mb-2">Body</h3>
      <p className="text-gray-700 mb-4">{body}</p>
      <h3 className="text-black font-bold mb-2">HTML Content</h3>
